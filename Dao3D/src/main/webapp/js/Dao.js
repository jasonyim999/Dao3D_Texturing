...
class Dao{
	...
	initialBuffer(){
		...
		mdl_road.initialMatrix();
		mdl_road2.initialMatrix();
		mdl_road3.initialMatrix();
	...
	setUpBuffer(){
		...
		mdl_road = new Column(4);
		mdl_road.scale = [200, 200, 0.1];
		mdl_road.rotate[0] = 90;
		mdl_road.rotate[2] = 45;
		mdl_road.translate[1] = -7.1;
		
		mdl_road2 = new Column(4);
		mdl_road2.scale = [200, 200, 0.1];
		mdl_road2.rotate[0] = 90;
		mdl_road2.rotate[2] = 45;
		mdl_road2.translate[1] = -7.1;
		mdl_road2.translate[2] = 280;
		
		mdl_road3 = new Column(4);
		mdl_road3.scale = [200, 200, 0.1];
		mdl_road3.rotate[0] = 90;
		mdl_road3.rotate[2] = 45;
		mdl_road3.translate[1] = -7.1;
		mdl_road3.translate[2] = -280;
		
		mdl_land = new Column(4);
		mdl_land.scale = [1000, 1000, 0.1];
		mdl_land.rotate[0] = 90;
		mdl_land.rotate[2] = 45;
		mdl_land.translate[1] = -7.15;
		...
		roadImg = new Image();
		roadImg.src = 'img/road_img.jpg';
		mdl_road.img = roadImg;
	...
	mdlDraw(){
		...
		mdl_road.setupImgBuffer();
		mdl_road.drawColumn();
		mdl_road2.drawColumn();
		mdl_road3.drawColumn();
